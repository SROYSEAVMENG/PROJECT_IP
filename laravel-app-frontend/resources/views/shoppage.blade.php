...
<body>
    ...
    <section id="header">
        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="chttp://127.0.0.1:5173/contactpage">Contact</a></li>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            <div class="pro" onclick="window.location.href='http://127.0.0.1:5173/sproductpage';">
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>3CE</span>
                    <h5>Matte Lip Color #222 Step And Go</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>3CE</span>
                    <h5>Judydoll Makeup Remover Pen</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>3CE</span>
                    <h5>&be Cushion foundation 12g</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>3CE</span>
                    <h5>Whiskered Hip Wide Jeans</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                ...
                <div class="des">
                    <span>3CE</span>
                    <h5>One Button Cropped Check Blazer</h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
